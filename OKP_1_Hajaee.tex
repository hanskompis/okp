...
\end{verbatim}
Ensimmäisenä tulee määritellä moduulin nimi, tässä tapauksessa 'fibo'.\newline
Jotta moduulissa olevia metodeita pystytään ohjelman ulkopuolella, tulee ne määritellä export-lauseella ulkopuolelta kutsuttaviksi. Jokaisen määrityksen yhteydessä
